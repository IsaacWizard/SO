...
public class SJN extends javax.swing.JInternalFrame {

    /**
     * Creates new form SJN
     */
    public static int msCh; //mostrar Chrome 
    public static int msIe;
    public static double SJIS,SJTE,SJTS;
    boolean estado=true; 
    ...
    private void initComponents() {
        ...
        action.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Estadistica.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Estadistica.setBounds(110, 610, 150, 24);

        lTiempo.setText("0");
        jPanel1.add(lTiempo);
        lTiempo.setBounds(430, 195, 20, 20);
    ...
    public void ejecutar(){
        ...
        if(t==l){ //cuando se cumpla el tiempo de ejecución
                ...
                if(imgMcG==EspE.getIcon()){
                    p=pMc;
                }
                if(imgCdG==EspE.getIcon()){
                    p=pCd;
                }
                t=0;
                ocupado=false;
        ...
        tt++;
        lTiempo.setText(String.valueOf(t));
    }
    ...
    public int nuevoProceso(String nombre){
        ...
        for(int t=0; t<procesos.length; t++){
               if(procesos[t]==null){ //comprobamos que esté vacio el espacio
                   ...
                   System.out.println("Acabas de crear proceso "+procesos[t].getNombre());
                   p=t;
