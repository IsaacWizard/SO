...
public class RoundRobin extends javax.swing.JInternalFrame {

    /**
     * Creates new form RoundRobin
     */
    public static int mrCh; //mostrar Chrome 
    public static int mrIe;
    public static double RIS,RTS,RTE;
    boolean estado=true; 
    ...
    int p; //aquí asignamos la posición del vector en la que está guardado el RoundRobin
